...
CREATE TABLE utilizadores (
    ...
    tipo_utilizador ENUM('admin', 'cliente') NOT NULL DEFAULT 'cliente',
...
-- Palavra-passe padrão para todos os testes: 'gpsi12'
INSERT INTO utilizadores (id, nome, nif, email, palavra_passe, tipo_utilizador) VALUES 
(1, 'Admin', NULL, 'admin@devbank.pt', '$2y$12$SsenxSO99jdaC4W.4PMiAO3kMF4SxuPmMciTLKAxUiCa6KxFeXeaW', 'admin'),
(2, 'Ana Silva', '254123987', 'ana.silva@escola.pt', '$2y$12$SsenxSO99jdaC4W.4PMiAO3kMF4SxuPmMciTLKAxUiCa6KxFeXeaW', 'cliente'),
(3, 'Rui Santos', '210987654', 'rui.santos@escola.pt', '$2y$12$SsenxSO99jdaC4W.4PMiAO3kMF4SxuPmMciTLKAxUiCa6KxFeXeaW', 'cliente');
...
-- PIN padrão para os testes do Multibanco: '1234'
INSERT INTO cartoes (id, conta_id, numero_cartao, pin_encriptado, estado, validade) VALUES 
(1, 1, '5044123456789012', '$2y$12$BcFcO0XhAjEfgSaVaydzN.iMv1NX3ZmFXtDcxcQC3wD60SIhhfiRW', 'ativo', '2030-12-31'),
(2, 3, '5044987654321098', '$2y$12$BcFcO0XhAjEfgSaVaydzN.iMv1NX3ZmFXtDcxcQC3wD60SIhhfiRW', 'ativo', '2029-08-31');
